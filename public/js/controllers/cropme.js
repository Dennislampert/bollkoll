    ...
    return {
      ...
      link: function(scope, element, attributes) {
        ...
        scope.cancel = function($event) {
          ...
          scope.dropText = "Släpp bilder här";
          scope.dropClass = "";
          scope.state = "step-1";
          delete scope.imgSrc;
